...
int main() {
  ...
  if (1 != ((long double)5.0 == (long double)5.0)) return 60;
  if (0 != ((long double)5.0 == (long double)5.2)) return 61;

  if (1 != (to_ldouble(5.0) == 5.0)) return 62;
  if (0 != (to_ldouble(5.0) == 5.2)) return 63;

  if (6 != add_all(3,1,2,3)) return 64;
  if (5 != add_all(4,1,2,3,-1)) return 65;

  if (306 != fnptr(add_all)(4, 1, 2, 3, 300)) return 66;

...
static const char *findIncludePath2(ParserContext *ctx, const char *includeName, Boolean dquoted) {
...
static void handleIncludeDirective(ParserContext *ctx, Token *d) {
  ...
  const char *includePath = findIncludePath2(ctx, fileName, dquoted);
